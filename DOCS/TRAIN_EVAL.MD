...
**1. Generate the Inflated Occupancy Annotations as described [here](DOCS/DATASET.MD):**
...
Configuration Files:
1) [inflated/action_condition_GMO.py](../projects/configs/inflated/action_condition_GMO.py): Predicts General Moveable Objects (GMO) using the inflated occupancy annotations as defined in Voxel4D Core.
2) [inflated/action_condition_MMO.py](../projects/configs/inflated/action_condition_MMO.py): Predicts Multi-class Moveable Objects (MMO) using the inflated occupancy annotations defined in Voxel4D Core.
