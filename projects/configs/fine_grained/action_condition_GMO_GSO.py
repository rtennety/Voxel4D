...
only_generate_dataset = False # only generate Core dataset, no forward
...
model = dict(
    ...
    future_pred_head=dict(
        ...
        use_can_bus=True,    # use future gt traj
        use_plan_traj=False, # use future pred traj      4D-Occ-Pred: must use_plan_traj=True
        use_command=True,
